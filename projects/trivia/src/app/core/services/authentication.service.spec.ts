...
import { MatDialogRef, MatDialog, OverlayRef, MatDialogConfig } from '@angular/material';
...
describe('Service: AuthenticationService', () => {
  ...
  it('Login', 
    ...
    ],  //MatDialogRef, dRef: MatDialogRef<LoginComponent>, 
  ...
  it('getUserRoles', 
    ...
    (service: AuthenticationService, dialog: MatDialog, db: AngularFireDatabase, store: Store<AppStore>) => {
      ...
      spyOn(db, 'object')
          .and.returnValue(of(["admin", "supervisor"]));
